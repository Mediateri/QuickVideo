...
def show
    ...
    @token = Twilio::JWT::AccessToken.new(Rails.application.credentials.account_sid, Rails.application.credentials.api_key_sid, Rails.application.credentials.api_key_secret, identity: identity)
